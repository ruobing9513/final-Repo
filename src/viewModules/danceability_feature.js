...
import definition_d from './defi_d.js';

	function danceability(rootDOM, data){
	    ...
	    nodes.merge(nodesEnter)
	        ...
	        .attr('r',4)
	        .attr('fill-opacity',1)
	        .style('fill', d=>colorScale(d.danceability));
	            ...
	            tooltip
	                // TRACK IMAGE AND RANKING DOESNT MATCH WITH THE TRACK AND ARTIST 
	                  .html(
	                  	...
	                  	//feature attr
	                    + '<span style="color:#DC143C" align="center">Danceability: ' + d.danceability + '</span>'
	                    + "<br/>" + 'Energy: ' + d.energy 
