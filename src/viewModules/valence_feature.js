...
import definition_v from './defi_v.js';

	function valence(rootDOM, data){
	            ...
	            tooltip
	                // TRACK IMAGE AND RANKING DOESNT MATCH WITH THE TRACK AND ARTIST 
	                  .html(
	                  	...
	                  	//feature attr
	                    + 'Danceability: ' + d.danceability + '</span>'
	                    + "<br/>" + 'Energy: ' + d.energy
	                    + "<br/>" + 'Speechiness: ' + d.speechiness
	                    + "<br/>" + '<span style="color:#DC143C" align="center"> Valence: ' + d.valence + '</span>'
